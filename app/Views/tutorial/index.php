...
<section class="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900">
    <div class="flex justify-between px-4 mx-auto max-w-screen-xl">
        <article class="mx-auto w-full max-w-full format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
            <header class="mb-4 lg:mb-6 not-format">
                <h1 class="mb-4 text-3xl md:text-4xl font-bold text-center leading-tight text-gray-900 lg:mb-6 lg:text-4xl dark:text-white">Dokumentasi Teknis Halo kak!</h1>
            </header>
            <p class="mb-4">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Minus quisquam est natus sunt fuga facere unde culpa vel totam tempora, nulla dolore. Nesciunt nihil obcaecati dicta ducimus, atque iure repudiandae voluptas enim provident laboriosam vero accusantium mollitia rem eveniet magnam et quaerat? Eligendi tempora iure inventore cum temporibus repudiandae quasi.</p>

            <p class="mb-4">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aspernatur distinctio ex ea, perspiciatis eveniet perferendis sapiente voluptate saepe eos cumque totam consequatur animi harum, nihil repellat earum accusamus officia vero sunt deleniti error dignissimos dolor aliquid! Necessitatibus facere mollitia similique doloribus nihil vitae nobis, sint eos voluptate dolor! Facilis distinctio, asperiores blanditiis veritatis provident voluptatum numquam amet, sequi id adipisci deserunt quae enim dolorum, quibusdam architecto? Atque ipsum pariatur vitae.</p>
        </article>
    </div>
</section>
